...
var binding = process.platform === "darwin" ? require("./binding/darwin-x64/sqlite3.node") : process.platform === "win32" ? null : null;// require("./binding/win-x64/sqlite3.node") : null;
