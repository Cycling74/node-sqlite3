...
var binding = process.platform === "darwin" ? 
    require(`./binding/node-v${process.versions.modules}-darwin-x64/node_sqlite3.node`)
    : process.platform === "win32" ? require(`./binding/node-v${process.versions.modules}-win32-x64/node_sqlite3.node`)
    : require(`./binding/node-v${process.versions.modules}-${process.platform}-x64/node_sqlite3.node`);
